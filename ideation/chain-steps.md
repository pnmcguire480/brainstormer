# BrainStormer — Chain Steps Reference

Detailed prompts and instructions for each step of the BrainStormer chain.
...
file. This is what makes BrainStormer compound — each run teaches the system
something about what works for this user and audience.

### Internal Prompt Template

```
Review the full output of this BrainStormer run:
- Audience: {snapshot}
- Idea: {idea}
